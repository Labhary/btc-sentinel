...
enforces exact-time evidence and required-source failures. The initial
2022–2025 replay exposed an invalid derived-monthly warm-up. Its corrected
authoritative rerun completed all 140,250 boundaries with native monthly
warm-up, but created only one signal and no eligible out-of-sample trade or
walk-forward fold. Both variants remain INCONCLUSIVE and no win rate is
available. The complete historical command is wired, and the public monthly
Binance Vision market archive can be acquired without credentials. The
historical risk timeline can be derived from
...
after that boundary. The successful workflow and its complete report are
recorded in `representative-backtest-2022-2025.md`. This is engineering
readiness, not sufficient performance evidence.
